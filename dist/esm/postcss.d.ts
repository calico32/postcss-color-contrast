...
declare type DeclarationProcessorStub = (decl: DeclarationStub, helper: unknown) => Promise<void> | void;
interface ProcessorsStub {
    Declaration?: DeclarationProcessorStub | {
        [prop: string]: DeclarationProcessorStub;
    };
    DeclarationExit?: DeclarationProcessorStub | {
        [prop: string]: DeclarationProcessorStub;
    };
}
